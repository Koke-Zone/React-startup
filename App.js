...
import macaroni from "./assets/images/macaroni.avif";

const Header = () => {
  return (
    <header className="header">
      <div className="logo">
        <img src={logo} width={50} height={50} alt="header logo" />
        <h1 className="heading">FoodCuts</h1>
      </div>
...
const FoodCard = (props) => {
  const { resList } = props;
  const { name, cuisines,avgRating,minDeliveryTime,costForTwoString} = resList.data;
  console.log(resList);
  return (
    <div className="food-card">
      <img
        src={
          ...
          resList.data.cloudinaryImageId
        }
        width={250}
        height={150}
        alt=""
      ...
      <span>
        Delivery Time: <b>&nbsp;{minDeliveryTime}</b>
      </span>
      <span>
        ...
        <div className="food-container">
          {
            restaurantList.map((restaurantList) => (
              <FoodCard key={restaurantList.data.id} resList={restaurantList} />
            )
            )
          }
        </div>
...
const Footer = () => {
  return (
    <div className="footer">
      <span className="copyright">All Rights Reserved &copy; 2024</span>
    </div>
  );
};
